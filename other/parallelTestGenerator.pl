...
###############################################################################
#                                                                             #
#    NNLBD Test Config Generator And Executor For Parallel Testing Scenarios  #
#              extension of (allGenerator.pl by Statler)                      #
#                                                                             #
...
#                                                                             #
#     Usage: Set Vector File Paths, then                                      #
#                "perl paralleltestgenerator.pl"                              #
#            Where the process will be forked for each scenario               #
#                                                                             #
...
my $number_of_epochs      = 500;
my $python_exec_path      = "python";           # python or python3
my $trainNN_path          = "../NN_LBD/NN/trainNN/trainNN.py";       # If TrainNN.py is in a different path than working directory
my $training_file         = "/home/share/NN_LBD/data/testTrain/known_newSmall_5000";
my $evaluation_file       = "/home/share/NN_LBD/data/testTrain/true_newSmall_5000";

# Vector File Paths (Edit Me)
my $onehot_concept_vector_file   = "/home/share/NN_LBD/data/vectors/vectors_onehot_cuis_newSmall_5000";
